...
const Home = () => {
    ...
    const getData = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                console.log(response.data.data.isSuperUser)
    ...
    console.log(userEmptyCheck, "jk")

    return (
        <React.Fragment>
            {userEmptyCheck && <nav class="navbar bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand">Incubation Program</a>
                    ...
                    <section className="ftco-section">
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    ...
                                    <div class="custom-file">
                                        <input onChange={handleChange} type="file" name="Logo" class="custom-file-input " id="inputGroupFile01"
                                            aria-describedby="inputGroupFileAddon01" />
                                        <label class="custom-file-label" for="inputGroupFile01">Company Logo</label>
                                    </div>
                                </div> */}
                        ...
                        <div className="container">
                            <div className="row ">
                                ...
                                <button className='d-flex align-items-center btn btn-info' data-toggle="modal" data-target="#modalSubscriptionForm">Apply</button>
            ...
            <UserApplications />
            {console.log(UserApplications, ";kdf")}
